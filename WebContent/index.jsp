              ...
              <form action="EnviarCorreoServlet" method="POST" role="form" class="contactForm">
                ...
                <div class="form-row">
                  <div class="form-group col-lg-6">
                    <input type="text" name="nombreContacto" class="form-control" id="nombreContacto" placeholder="Tu Nombre" data-rule="minlen:4" data-msg="Por favor ingresa al menos cuatro caracteres" required/>
                    <div class="validation"></div>
                  </div>
                  <div class="form-group col-lg-6">
                    <input type="email" class="form-control" name="correoContacto" id="correoContacto" placeholder="Tu Correo" data-rule="email" data-msg="Por favor ingresa un correo válido" required/>
                    <div class="validation"></div>
                  </div>
                </div>
                <div class="form-group">
                  <input type="text" class="form-control" name="asuntoContacto" id="asuntoContacto" placeholder="Asunto" data-rule="minlen:4" data-msg="Ingresa al menos 8 caracteres" required/>
                  <div class="validation"></div>
                </div>
                <div class="form-group">
                  <textarea class="form-control" name="mensajeContacto" rows="5" data-rule="required" data-msg="¿Cómo podemos ayudarte?" placeholder="Mensaje" required></textarea>
                  <div class="validation"></div>
                </div>
